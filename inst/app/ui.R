  ...
  navbarPage(
    ...
    tabPanel("Download Data",
             ...
             div(class="download_item",
                 ...
                 actionButton("info_fields", "More Info", onclick ="window.open('https://flowwest.github.io/fishFoodMWD/reference/ff_fields.html', '_blank')"),
             ...
             div(class="download_item",
                 ...
                 actionButton("info_distances", "More Info", onclick ="window.open('https://flowwest.github.io/fishFoodMWD/reference/ff_distances.html', '_blank')"),
             ...
             div(class="download_item",
                 ...
                 actionButton("info_watersheds", "More Info", onclick ="window.open('https://flowwest.github.io/fishFoodMWD/reference/ff_watersheds.html', '_blank')"),
             ...
             div(class="download_item",
                 ...
                 actionButton("info_returns", "More Info", onclick ="window.open('https://flowwest.github.io/fishFoodMWD/reference/ff_returns.html', '_blank')"),
             ...
             div(class="download_item",
                 ...
                 actionButton("info_streams", "More Info", onclick ="window.open('https://flowwest.github.io/fishFoodMWD/reference/ff_streams.html', '_blank')"),
             ...
             div(class="download_item",
                 ...
                 actionButton("info_canals", "More Info", onclick ="window.open('https://flowwest.github.io/fishFoodMWD/reference/ff_canals.html', '_blank')"),
             ...
             div(class="download_item",
                 ...
                 actionButton("info_wetdry", "More Info", onclick ="window.open('https://flowwest.github.io/fishFoodMWD/reference/ff_wetdry.html', '_blank')"),
